    ...
    <>
      ...
      >
        <div className='group flex flex-col items-center justify-center'>
          <svg
            className='h-12 w-12 fill-current text-[#0000A3] transition-all duration-300 group-hover:scale-125'
            viewBox='0 0 43 30'
          >
            <path
              fillRule='evenodd'
          ...
          <p className='-mt-1 transition-all duration-300 group-hover:scale-125'>Axiacore</p>
        </div>
        <div className='flex h-12 items-end justify-center rounded-md bg-slate-50 transition-all duration-300 hover:scale-125'>
          <Image
            src={'/tailorsoft.png'}
